...
# Título
titulo = tk.Label(frame, text="Calcula tu Huella Hídrica", font=("Arial", 16, "bold"), bg="#1E5959", fg="#2c3e50")
titulo.pack(pady=10)
...
duchas_label = tk.Label(frame, text="¿Cuántas duchas tomas al día?", bg="#1E5959", font=("Arial", 12))
...
duchas_valor_label = tk.Label(frame, textvariable=duchas_valor, bg="#1E5959", font=("Arial", 12))
duchas_valor_label.pack()

# Pregunta 2: ¿Cuánto dura una ducha promedio (en minutos)?
tiempo_label = tk.Label(frame, text="¿Cuánto dura una ducha promedio (en minutos)?", bg="#1E5959", font=("Arial", 12))
...
tiempo_valor_label = tk.Label(frame, textvariable=tiempo_valor, bg="#1E5959", font=("Arial", 12))
tiempo_valor_label.pack()

# Pregunta 3: ¿Cuánto tiempo dejas el grifo abierto diariamente (en minutos)?
grifo_label = tk.Label(frame, text="¿Cuánto tiempo dejas el grifo abierto diariamente (en minutos)?", bg="#1E5959", font=("Arial", 12))
...
grifo_valor_label = tk.Label(frame, textvariable=grifo_valor, bg="#1E5959", font=("Arial", 12))
grifo_valor_label.pack()

# Pregunta 4: ¿Cuántas veces lavas ropa a la semana?
ropa_label = tk.Label(frame, text="¿Cuántas veces lavas ropa a la semana?", bg="#1E5959", font=("Arial", 12))
...
ropa_valor_label = tk.Label(frame, textvariable=ropa_valor, bg="#1E5959", font=("Arial", 12))
ropa_valor_label.pack()

# Pregunta 5: ¿Si tienes coche, cuántas veces lo lavas al mes?
coche_label = tk.Label(frame, text="¿Si tienes coche, cuántas veces lo lavas al mes?", bg="#1E5959", font=("Arial", 12))
...
coche_valor_label = tk.Label(frame, textvariable=coche_valor, bg="#1E5959", font=("Arial", 12))
coche_valor_label.pack()

# Pregunta 6: ¿Cuántas veces usas la lavadora por semana?
lavadora_label = tk.Label(frame, text="¿Cuántas veces usas la lavadora por semana?", bg="#1E5959", font=("Arial", 12))
...
lavadora_valor_label = tk.Label(frame, textvariable=lavadora_valor, bg="#1E5959", font=("Arial", 12))
lavadora_valor_label.pack()

# Pregunta 7: ¿Cómo describirías tu consumo de carne?
carne_label = tk.Label(frame, text="¿Cómo describirías tu consumo de carne?", bg="#1E5959", font=("Arial", 12))
